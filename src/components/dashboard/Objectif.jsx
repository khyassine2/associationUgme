  ...
  return (
    <Box>
      {data.length!==0?<Paper sx={{ width: '80%', overflow: 'hidden',m:'auto' }}>
        <Typography variant="h5" align='right' sx={{marginTop:'3%',marginRight:'3%'}}><b>:الأهداف</b></Typography>
        <Stack sx={{ width:'95%',display:'flex',flexDirection:'row',justifyContent:'end',m:'auto' }}>
        <Button
      onClick={()=>navigate('/dashboard/الأهداف/إضافة')}
      variant="contained"
      sx={{
